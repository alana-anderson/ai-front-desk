  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4 pb-20">
      <div className="w-full max-w-2xl mx-auto text-center">
        ...
        {/* Chat input */}
        <Card
          className="p-3 flex items-center gap-3 cursor-pointer hover:shadow-md transition-shadow border border-slate-200 mb-10"
        ...
        >
          ...
          <span className="text-slate-400 text-left flex-1">
